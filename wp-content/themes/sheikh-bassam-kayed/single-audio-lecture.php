                ...
                <header class="single-post-header-creative">
                    <div class="post-header-content">
                        ...
                        <div class="post-meta-creative">
                            <?php if ( $audio_date ) : ?>
                                <span class="meta-badge"><i>📅</i> <?php echo esc_html( date_i18n( get_option( 'date_format' ), strtotime( $audio_date ) ) ); ?></span>
                            <?php else : ?>
                                <span class="meta-badge"><i>📆</i> <?php echo get_the_date(); ?></span>
                            <?php endif; ?>
                            <?php if ( $audio_category ) : ?>
                                <span class="meta-badge"><i>📂</i> <?php echo esc_html( $audio_category ); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </header>
                    ...
                    <?php if ( $audio_file ) : ?>
                        <div class="audio-player-section">
                            <div class="audio-player-wrapper">
                                <audio controls class="audio-player-large">
